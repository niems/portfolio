...
function DisplayLogo(props) {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height='100%' width='100%' viewBox="0 0 100 100"
            ...
            <path id='top-secondary' className='grid-design'  d='M20 15 L70 15' style={{strokeOpacity: svg.sPath.strokeOpacity, strokeWidth: svg.sPath.strokeWidth}} />
            ...
            <circle className='grid-node' r='0.8' cx='51.5' cy='48.5' style={{strokeWidth: svg.node.strokeWidth}} />
            <circle className='grid-node' r='0.8' cx='18.5' cy='81.5' style={{strokeWidth: svg.node.strokeWidth}} />

            <path id='mid-secondary' className='grid-design' d='M80 30 L40 70' style={{strokeOpacity: svg.sPath.strokeOpacity, strokeWidth: svg.sPath.strokeWidth}} />
            ...
            <path id='bottom-secondary' className='grid-design' d='M25 86 h15' style={{strokeOpacity: svg.sPath.strokeOpacity, strokeWidth: svg.sPath.strokeWidth}} />
            <path id='bottom-secondary' className='grid-design' d='M52 86 L86 86' style={{strokeOpacity: svg.sPath.strokeOpacity, strokeWidth: svg.sPath.strokeWidth}} />
        </svg>
    );
}
